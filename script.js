...
// 		headerLogo.classList.add('check__color')
// 		headerSearch.classList.add('header__search-toggle')
// 		togglerSlider.classList.add('check__background-black')
...
// 		}
// 		modalCard.classList.add('modal__card-toggle')
// 		modalOverview.classList.add('modal__overview-toggle')
// 		modalSite.classList.add('check__color')
// 		btnModalClose.classList.add('button__close-toggle')
// 	} else {
// 		headerLogo.classList.remove('check__color')
// 		headerSearch.classList.remove('header__search-toggle')
// 		togglerSlider.classList.remove('check__background-black')
// 		for (let i = 0; i < movieTitle.length; i++) {
...
// 		}
// 		modalCard.classList.remove('modal__card-toggle')
// 		modalOverview.classList.remove('modal__overview-toggle')
// 		modalSite.classList.remove('check__color')
// 		btnModalClose.classList.remove('button__close-toggle')
// 	}
// }
