...
// 			},
// 		});
// 		const respData = await repsonse.json()
...
// 		// console.log('voteNULL:', vote)
// 		return 'Нету рейтинга'
// 	} else if (vote != 'null') {
// 		// console.log(typeof vote)
// 		// console.log('vote!==NULL:', vote)
// 		return vote;
// 	}
// }
...
// 	// Очищаем контейнер с фильмами container.innerHTML=""
// 	moviesEl.innerHTML = ''
...
// 		firstClone.querySelector('.movie___cover--inner img').src = `${movie.posterUrl}`
// 		firstClone.querySelector('.movie__title').textContent = `${(!movie.nameRu) ? movie.nameEn : movie.nameRu}`
// 		firstClone.querySelector('.movie__average').textContent = `${getClassByRate(movie.rating)}`
// 		// getClassByRate(movie.rating)
// 		firstClone.querySelector('.movie__year').textContent = `${movie.year}`
// 		const category = firstClone.querySelector('.movie__category')
// 		movie.genres.forEach(item => {
// 			const text = document.createElement('span')
// 			text.textContent = item.genre
// 			category.append(text)
// 		})
// 		const movieAverage = firstClone.querySelector('.movie__average')
// 		if (movie.rating >= 7) {
// 			// console.log('movie.ratingGREEN:', movie.rating)
// 			movieAverage.classList.add('movie__average--green')
// 		} else if (movie.rating >= 6) {
// 			// console.log('movie.ratingGREY:', movie.rating)
// 			movieAverage.classList.add('movie__average--grey')
// 		} else if (movie.rating > 0) {
// 			// console.log('movie.ratingRED:', movie.rating)
